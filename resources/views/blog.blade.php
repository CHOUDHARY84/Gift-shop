                ...
                <div class="col-lg-4 col-12 mb-60">
                    <div class="sidebar-wrapper">
                        ...
                        <div class="single-sidebar mb-30">
                            ...
                            <!-- Newsletter Form -->
                            <form action="{{asset('res/http://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef{{asset('res/" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="sidebar-subscribe-form validate" target="_blank" novalidate>
