@include('header')     
    ...
    <div class="hero-slider section fix">
        ...
        <div class="hero-item" style="background-image: url({{asset('res/img/hero/1.jpg')}})">
        ...
        <!-- Hero Slide Item Start-->
        <div class="hero-item" style="background-image: url({{asset('res/img/hero/2.jpg)')}}">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-30">
                    ...
                    <div class="single-banner">
                        <img src="{{asset('res/img/banner/1.jpg')}}" alt="banner">
                ...
                <div class="col-lg-6 col-12 mb-30">
                    ...
                    <div class="single-banner">
                        <img src="{{asset('res/img/banner/2.jpg')}}" alt="banner">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.html" class="img"><img src="{{asset('res/img/product/1.jpg')}}" alt="Product"></a>
                            <!-- Wishlist -->
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.html" class="img"><img src="{{asset('res/img/product/2.jpg')}}" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.html" class="img"><img src="{{asset('res/img/product/3.jpg')}}" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.html" class="img"><img src="{{asset('res/img/product/4.jpg')}}" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <span class="label">New</span>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.html" class="img"><img src="{{asset('res/img/product/5.jpg')}}" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <div class="product">
                        ...
                        <div class="image">
                            <!-- Image -->
                            <a href="product-details.html" class="img"><img src="{{asset('res/img/product/6.jpg')}}" alt="Product"></a>
                            <!-- Wishlist -->
                            <a href="#" class="wishlist"><i class="fa fa-heart-o"></i></a>
                            <!-- Label -->
                            <!-- <span class="label">New</span> -->
    ...
    <div class="testimonial-section section bg-gray pt-100 pb-65" style="background-image: url({{asset('res/img/bg/testimonial.png')}})">
        <div class="container">
                ...
                <div class="col-lg-8 col-md-10 col-12 ml-auto mr-auto">
                    ...
                    <div class="testimonial-slider text-center">
                        ...
                        <div class="single-testimonial">
                            <img src="{{asset('res/img/testimonial/1.jpg')}}" alt="customer">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="blog-item col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <!-- Image -->
                    <a href="blog-details.html" class="image"><img src="{{asset('res/img/blog/1.jpg')}}" alt="blog"></a>
                ...
                <div class="blog-item col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <!-- Image -->
                    <a href="blog-details.html" class="image"><img src="{{asset('res/img/blog/2.jpg')}}" alt="blog"></a>
                ...
                <div class="blog-item col-lg-4 col-md-6 col-12 mb-60">
                    ...
                    <!-- Image -->
                    <a href="blog-details.html" class="image"><img src="{{asset('res/img/blog/3.jpg')}}" alt="blog"></a>
