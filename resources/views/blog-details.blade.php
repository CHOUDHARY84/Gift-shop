                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="blog-item">
                                ...
                                <!-- Image -->
                                <div class="img"><img src="{{asset('res/img/blog/details.jpg')}}" alt="blog"></div>
                                ...
                                <div class="content fix">
                                    ...
                                    <!-- Title -->
                                    <h4 class="title">If you are going to use a passage latin at Hampdun.</h4>
                                    ...
                                    <div class="row row-5 mb-20">
                                        <div class="col-md-4 col-sm-6 col-xs-12 mb-10"><img src="{{asset('res/img/blog/blog-gallery-1.jpg')}}" alt=""></div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 mb-10"><img src="{{asset('res/img/blog/blog-gallery-2.jpg')}}" alt=""></div>
                                        <div class="col-md-4 col-sm-6 col-xs-12 mb-10"><img src="{{asset('res/img/blog/blog-gallery-3.jpg')}}" alt=""></div>
                                    </div>
                                ...
                                <ul class="comment-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="single-comment fix">
                                            ...
                                            <div class="image float-left">
                                                <img src="{{asset('res/img/comment/1.jpg')}}" alt="">
                                            </div>
                                        ...
                                        <ul class="child-comment">
                                            ...
                                            <li>
                                                ...
                                                <div class="single-comment fix">
                                                    ...
                                                    <!-- Image -->
                                                    <div class="image float-left">
                                                        <img src="{{asset('res/img/comment/2.jpg')}}" alt="">
                                                    </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="single-comment fix">
                                            ...
                                            <!-- Image -->
                                            <div class="image float-left">
                                                <img src="{{asset('res/img/comment/3.jpg')}}" alt="">
                                            </div>
                    ...
                    <div class="sidebar-wrapper">
                        ...
                        <div class="single-sidebar mb-30">
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.html" class="image"><img src="{{asset('res/img/blog/sidebar-post-1.jpg')}}" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.html" class="image"><img src="{{asset('res/img/blog/sidebar-post-2.jpg')}}" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
                            ...
                            <div class="sidebar-post fix">
                                <!-- Image -->
                                <a href="blog-details.html" class="image"><img src="{{asset('res/img/blog/sidebar-post-3.jpg')}}" alt=""></a>
                                <!-- Content -->
                                <div class="content fix">
                                    <span class="date">20 JUN 2016</span>
                                    <a href="blog-details.html" class="title">Going to use a passage.</a>
                        ...
                        <div class="single-sidebar mb-30">
                            ...
                            <!-- Newsletter Form -->
                            <form action="{{asset('res/http://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef')}}" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="sidebar-subscribe-form validate" target="_blank" novalidate>
