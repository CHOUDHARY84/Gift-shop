            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-12 mb-30">
                    ...
                    <div class="single-product-thumbnail product-thumbnail-slider float-left">
                        <div class="single-thumb"><img src="{{asset('res/img/product-details/thumb-1.jpg')}}" alt=""></div>
                        <div class="single-thumb"><img src="{{asset('res/img/product-details/thumb-2.jpg')}}" alt=""></div>
                        <div class="single-thumb"><img src="{{asset('res/img/product-details/thumb-3.jpg')}}" alt=""></div>
                        <div class="single-thumb"><img src="{{asset('res/img/product-details/thumb-4.jpg')}}" alt=""></div>
                    </div>
                    
                    <!-- Product Image -->
                    <div class="single-product-image product-image-slider fix">
                        <div class="single-image"><img src="{{asset('res/img/product-details/1.jpg')}}" alt=""></div>
                        <div class="single-image"><img src="{{asset('res/img/product-details/2.jpg')}}" alt=""></div>
                        <div class="single-image"><img src="{{asset('res/img/product-details/3.jpg')}}" alt=""></div>
                        <div class="single-image"><img src="{{asset('res/img/product-details/4.jpg')}}" alt=""></div>
                    </div>
