        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="about-image col-lg-6 col-12 mb-30">
                    <a class="video-popup" href="{{asset('res/https://www.youtube.com/watch?v=7e90gBu4pas')}}"><img src="{{asset('res/img/about.jpg')}}" alt=""></a>
                </div>
        ...
        <div class="container">
            ...
            <div class="team-wrapper row">
                ...
                <div class="single-team col-lg-3 col-md-6 col-12">
                    <img src="{{asset('res/img/team/1.jpg')}}" alt="team">
                    <div class="content">
                        <h4>Terry Soto</h4>
                        <span>CEO</span>
                    </div>
                ...
                <div class="single-team col-lg-3 col-md-6 col-12">
                    <img src="{{asset('res/img/team/2.jpg')}}" alt="team">
                    <div class="content">
                        <h4>Maria Lane</h4>
                        <span>Marketer</span>
                    </div>
                ...
                <div class="single-team col-lg-3 col-md-6 col-12">
                    <img src="{{asset('res/img/team/3.jpg')}}" alt="team">
                    <div class="content">
                        <h4>Justin Evans</h4>
                        <span>developer</span>
                    </div>
                ...
                <div class="single-team col-lg-3 col-md-6 col-12">
                    <img src="{{asset('res/img/team/4.jpg')}}" alt="team">
                    <div class="content">
                        <h4>Rose Dixon</h4>
                        <span>Designer</span>
                    </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="client-slider text-center">
                        ...
                        <!-- Single Client -->
                        <div class="single-client"><img src="{{asset('res/img/client/1.png')}}" alt="client"></div>
                        <div class="single-client"><img src="{{asset('res/img/client/2.png')}}" alt="client"></div>
                        <div class="single-client"><img src="{{asset('res/img/client/3.png')}}" alt="client"></div>
                        <div class="single-client"><img src="{{asset('res/img/client/4.png')}}" alt="client"></div>
                        <div class="single-client"><img src="{{asset('res/img/client/5.png')}}" alt="client"></div>
                        <div class="single-client"><img src="{{asset('res/img/client/6.png')}}" alt="client"></div>
