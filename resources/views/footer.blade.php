    ...
    <div class="footer-section section bg-dark" style="background-image: {{asset('res/url(img/bg/footer-bg.png)')}}">
        <div class="container">
                    ...
                    <div class="footer-top section pt-80 pb-50">
                        <div class="row">
                            ...
                            <div class="footer-widget col-lg-4 col-md-6 col-12 mb-40">
                                ...
                                <img class="footer-logo" src="{{asset('res/img/footer-logo.png')}}" alt="logo">
...
<!-- jQuery JS -->
<script src="{{asset('res/js/vendor/jquery-1.12.0.min.js')}}"></script>
<!-- Popper JS -->
<script src="{{asset('res/js/popper.min.js')}}"></script>
<!-- Bootstrap JS -->
<script src="{{asset('res/js/bootstrap.min.js')}}"></script>
<!-- Plugins JS -->
<script src="{{asset('res/js/plugins.js')}}"></script>
<!-- Ajax Mail JS -->
<script src="{{asset('res/js/ajax-mail.js')}}"></script>
<!-- Main JS -->
